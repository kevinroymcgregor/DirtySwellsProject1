...
function createEventLists(name, date, description, game) {
    ...
    const listDivBody = $("<div class='collapsible-body'><span>Date: " + date + "</span></div>");
    listDivBody.append($("<br>"));
    listDivBody.append($("<span>").text(`Playing: ${game}`));
    listDivBody.append($("<br>"));
    listDivBody.append($("<br>"));
    listDivBody.append($("<span>").text(`Description: ${description}`));
